 ...
 * append an entry here and it appears in the picker, the renderer, and the
 * OG image with no other edits.
 */
...
export const THEMES: Record<ThemeId, Theme> = {
  "ivory-gold": {
    id: "ivory-gold",
    name: "Ivory & Gold",
    blurb: "Warm paper, gold hairlines, unhurried serif.",
    dark: false,
    fonts: "classic",
    ornament: "diamond",
    surface: "grain",
  ...
  "onyx-champagne": {
    id: "onyx-champagne",
    name: "Onyx & Champagne",
    blurb: "Near-black ground, champagne foil, deco rules.",
    dark: true,
    fonts: "deco",
    ornament: "deco",
    surface: "none",
  ...
  "emerald-brass": {
    id: "emerald-brass",
    name: "Emerald & Brass",
    blurb: "Deep green and brass, Arabic given room to breathe.",
    dark: false,
    fonts: "garamond",
    ornament: "leaf",
    surface: "linen",
  ...
  "iznik-blue": {
    id: "iznik-blue",
    name: "Iznik Blue",
    blurb: "Ottoman tilework — cobalt, white, a line of coral.",
    dark: false,
    fonts: "classic",
    ornament: "tile",
    surface: "none",
  ...
  "marble-gilt": {
    id: "marble-gilt",
    name: "Marble & Gilt",
    blurb: "Veined stone under gilt geometry.",
    dark: false,
    fonts: "deco",
    ornament: "deco",
    surface: "marble",
  ...
  rosewater: {
    id: "rosewater",
    name: "Rosewater",
    blurb: "Blush ground, botanical line-work, soft contrast.",
    dark: false,
    fonts: "modern",
    ornament: "leaf",
    surface: "grain",
  ...
  "sand-terracotta": {
    ...
    blurb: "Warm earth, contemporary, restrained.",
    dark: false,
    fonts: "modern",
    ornament: "weave",
    surface: "linen",
  ...
  kasavu: {
    id: "kasavu",
    name: "Kasavu",
    blurb: "Off-white cloth with a gold border, Kerala by way of the loom.",
    dark: false,
    fonts: "garamond",
    ornament: "weave",
    surface: "linen",
